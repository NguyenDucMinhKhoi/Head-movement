...
class Pose_300W_LP(Dataset):
    ...
    def __init__(self, data_dir, filename_path, ref_dir, ref_filename_path, transform=None):
        ...
        self.transform =  transforms.Compose([transforms.ToTensor(),transforms.RandomResizedCrop(size=(64,64),scale=(0.8,1.2), antialias=True), transforms.Normalize(0,1)])
...
class BIWI(Dataset):
    ...
    def __init__(self, data_dir, filename_path, ref_dir, ref_filename_path, transform=None, mode='eval'):
        self.data_dir = data_dir
        self.ref_dir = ref_dir
        # print(data_dir, ref_dir)
        self.mode = mode
