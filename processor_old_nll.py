...
## Kiểm tra tập dữ liệu huấn luyện
    ...
    def load_optimizer(self):
        ...
        lr_scheduler_pre = optim.lr_scheduler.MultiStepLR(
            self.optimizer, milestones=self.arg.step, gamma=0.5)  # gammmmmmmmmmmmaaaaaaaaaaaa = 0.5
    ...
    def train(self, epoch, save_model=False):
        ...
        self.print_log('Training epoch: {}'.format(epoch + 1)) #In thông tin về epoch hiện tại
    ...
    def start(self):
        ...
        for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
            ...
            #xác thực sau mỗi lần huấn luyện xong 1 epoch 
            self.eval(
                epoch,
                loader_name=['test1'])
            ...
            self.eval(
                epoch,
                loader_name=['test2'])
           # Xác thực mỗi 5 epoch
          # if (epoch + 1) % 5 == 0:
          #     self.eval(epoch, loader_name=['test1'])
          #     self.eval(epoch, loader_name=['test2'])
